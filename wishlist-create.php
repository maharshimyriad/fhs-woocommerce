...
<div class="yith-wcwl-wishlist-new">
	...
	<p class="form-row form-row-wide wishlist-privacy-radio" style="max-height:0px; visibility:hidden; opacity:0; padding:0;">
		<label>
			<input type="radio" name="wishlist_visibility" class="wishlist-visiblity" value="0"/>
		...
		<label>
			<input type="radio" checked="checked"  name="wishlist_visibility" class="wishlist-visiblity" value="2"/>
