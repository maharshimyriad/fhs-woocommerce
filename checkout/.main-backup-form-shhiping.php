		...
		<div id="fhs-delivery-panel" class="fhs-mode-panel">
			<div class="shipping_address">
					...
					<p class="form-row form-row-wide" id="thwma_saved_shipping_field">
						...
						<span class="woocommerce-input-wrapper">
							<select id="thwma_saved_shipping" class="select" style="width:100%;">
								...
								<option value="same_as_billing"><?php esc_html_e( 'Same as billing address', 'woocommerce' ); ?></option>
				...
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox same-as-billing-toggle">
					<input
						id="fhs-use-same-as-billing-address-checkbox"
						class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox"
						type="checkbox"
						name="fhs_use_same_as_billing_address"
						value="1"
					/>
				...
				<div class="shipping-options-row">
					<div class="residential-delivery-group">
						...
						<label>
							<input type="radio" name="residential_delivery" value="yes"> <?php esc_html_e( 'Yes', 'woocommerce' ); ?>
						</label>
						<label>
							<input type="radio" name="residential_delivery" value="no" checked> <?php esc_html_e( 'No', 'woocommerce' ); ?>
						</label>
					</div>
				</div>
				...
				<?php if ( is_user_logged_in() ) : ?>
					<p class="form-row form-row-wide fhs-save-address-book-row">
						<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
							<input class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" type="checkbox" name="save_shipping_to_address_book" value="1" />
...
<!-- 		<p><strong><?php esc_html_e( 'Standard Opening Hours', 'woocommerce' ); ?></strong> <?php esc_html_e( 'are Monday-Thursday 7:30am-4:30pm, Friday 7:30am-3pm. Public Holidays Forklift loading available (only until 1pm Fridays)', 'woocommerce' ); ?></p> -->
		<p><strong><?php esc_html_e( 'Standard Opening Hours', 'woocommerce' ); ?></strong> <?php esc_html_e( 'are Monday-Thursday 7.30am-4.30pm, Friday 7.30am-3pm. Closed Public Holidays.', 'woocommerce' ); ?></p>
		<p><strong><?php esc_html_e( 'Forklift', 'woocommerce' ); ?></strong> <?php esc_html_e( 'loading available (only until 1pm Fridays)', 'woocommerce' ); ?></p><br>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    jQuery(billingStateElement).on('select2:select', function (e) {
        const value = e.target.value || 'N/A';
        localStorage.setItem('checkout_state', value);
