...
<?php else : ?>
	...
	<!-- ═══════════════════════════════════════════════════════════
	     Variation card grid
	     Each variation is rendered as a standalone purchasable card.
	     ═══════════════════════════════════════════════════════════ -->
	<div class="fhs-variation-cards" data-product_id="<?php echo absint( $product->get_id() ); ?>">
				...
				<?php if ( is_user_logged_in() ) : ?>
					...
					<?php if ( $can_add ) : ?>
						...
						<form class="fhs-variation-card__form cart"
							...
							<!-- Hidden fields that tell WooCommerce exactly which variation to add -->
	...
	<?php
	/*
	 * Hidden native variations_form — kept in the DOM (display:none) so the
	 * WooCommerce JS bundle (wc-add-to-cart-variation, cart fragments, etc.)
	 * still initialises and fires its events correctly.
	 */
	?>
